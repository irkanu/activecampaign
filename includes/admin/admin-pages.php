...
function ac_add_options_link() {
    ...
    $ac_settings_page      = add_menu_page( __( 'ActiveCampaign', 'ac' ), __( 'ActiveCampaign', 'ac' ), 'manage_shop_settings', 'ac-settings', 'ac_options_page', ACTIVE_CAMPAIGN_URL . 'assets/images/ac_symbol_trans_20.png' );
